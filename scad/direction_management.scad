 ...
 * Description: Direction management component for the Interactive Signalling Laboratory.
 * It is used to create a direction management for a track and a locking pin.
 */
